pipeline {
    ...
    parameters {  // Defines Parameters as Code
        string(name: "git_repository", defaultValue: "https://github.com/mateobur/sysdig-jenkins-ci-training.git", trim: true, description: "Git Repo to build Dockerfile from")
        ...
        string(name: "registry_repo", defaultValue: "mateobur", trim: true, description: "Container Registry URL")
